...
gulp.task('watch', async function(){
    ...
    gulp.watch(paths.dev.img, gulp.parallel(['img']));
    gulp.watch(paths.etc.font, gulp.parallel(['fonts']));
});

gulp.task('default', gulp.parallel('connect', 'js', 'css', 'html', 'img', 'fonts', 'watch'));
gulp.task('dev', gulp.parallel(['clean', 'connect', 'js', 'css', 'html', 'img', 'fonts', 'watch']));